...
<div id="app" class="container">
    ...
    <input type="hidden" name="search-top-parent-url" id="search-top-parent-url"
           value="<?php echo $module->getUrl("ajax/search_patient.php") ?>">
    ...
    <input type="hidden" name="project-id" id="project-id"
           value="<?php echo filter_var($_GET['pid'], FILTER_SANITIZE_NUMBER_INT) ?>">
    <div class="row p-1">
    ...
    <div id="filters-row" class="row p-1">
        <div class="col-lg-5 mt-2">
            <div class="row">
                <?php
                require_once($module->getModulePath() . "src/view/form.php");
                ?>
            </div>
        </div>
    </div>
    <div class="row p-1">
        <div class="col-12">
            <?php
            require_once($module->getModulePath() . "src/view/record.php");
            ?>
